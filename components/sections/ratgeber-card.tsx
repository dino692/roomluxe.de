  ...
  return (
    ...
    >
      <Link
        ...
        className="group block h-full rounded-3xl bg-cream-50 shadow-card hover:shadow-card-lg border border-gold-300/30 hover:border-gold-700/30 p-7 transition"
      >
